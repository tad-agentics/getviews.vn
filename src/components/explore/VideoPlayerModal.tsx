...
import { X, VolumeX, Volume2, Heart, MessageCircle, Share2, Eye } from "lucide-react";

export const PLACEHOLDER_THUMB = "/placeholder.svg";
            ...
            <div className="hidden md:block flex-1 overflow-y-auto" style={{ scrollbarWidth: "thin" }}>
              {allVideos.map((v) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="flex-shrink-0 rounded-md overflow-hidden border border-[var(--border)] relative"
