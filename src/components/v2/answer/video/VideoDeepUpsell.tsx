      ...
      <ul className="m-0 flex list-none flex-wrap gap-2 p-0">
        {lockedSections.map((sec) => (
          <li key={sec.section_id}>
            <span className="inline-flex min-h-[44px] items-center gap-1.5 rounded-full border border-dashed border-[color:var(--gv-rule)] bg-[color:var(--gv-canvas-2)] px-3 py-2 text-sm text-[color:var(--gv-ink-3)]">
