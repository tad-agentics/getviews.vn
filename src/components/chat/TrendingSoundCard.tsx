      ...
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-2">
            ...
            <span className="flex-shrink-0 font-mono text-xs font-semibold text-[var(--purple)] tabular-nums">
              {formatVN(data.usage_count)}
            </span>
          </div>
          <p className="mt-1 font-mono text-xs text-[var(--ink-soft)] tabular-nums">{formatVN(data.total_views)} lượt xem</p>
