...
export const DateChip = memo(function DateChip() {
  ...
  return (
    <span className="inline-flex items-center rounded-full border border-[color:var(--gv-rule)] bg-[color:var(--gv-paper)] px-3 py-1 gv-kicker text-[color:var(--gv-ink-3)]">
      {label}
    </span>
  );
});
