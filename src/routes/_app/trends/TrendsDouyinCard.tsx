...
export const TrendsDouyinCard = memo(function TrendsDouyinCard() {
  ...
  return (
    <button
      ...
      className="group mb-9 flex w-full items-center justify-between gap-4 rounded-[10px] border border-[color:var(--gv-rule)] bg-[color:var(--gv-paper)] px-[18px] py-3.5 text-left text-sm text-[color:var(--gv-ink-2)] transition-[border-color,transform] duration-150 hover:-translate-y-px hover:border-[color:var(--gv-ink)]"
    >
      <span className="flex min-w-0 items-center gap-3.5">
        ...
        <span className="flex min-w-0 flex-col">
          <span className="gv-mono mb-[3px] text-[11px] font-semibold gv-kicker tracking-[0.08em] text-[color:var(--gv-accent-deep)]">
      <span className="gv-kicker mr-1" aria-hidden>
        CN
      </span>
      TÍN HIỆU SỚM · DOUYIN → VN
          </span>
