...
- style_tags: 2–5 tag trong danh sách schema: text_overlay_heavy, talking_head, voiceover_only, b_roll_heavy, fast_cuts, slow_reveal, meme_format, before_after, reaction, duet_stitch, green_screen, product_showcase, lifestyle_b_roll, educational_slides, trending_audio, foreign_reup. Chỉ tag thấy rõ; không đoán.
  - foreign_reup: CHỈ gắn khi có bằng chứng footage nước ngoài (chữ Trung/Hàn/Nhật trên hình/audio gốc, chủ đề Trung/Hàn/Douyin, phụ đề dịch từ ngoại ngữ) — KHÔNG gắn cho creator Việt tự quay/review bằng tiếng Việt dù có voiceover_only, text_overlay_heavy hay overlay chữ Việt. «mua»/«review» trên phụ đề reup ≠ review native.
