...
- style_tags: 2–5 tag trong danh sách schema: text_overlay_heavy, talking_head, voiceover_only, b_roll_heavy, fast_cuts, slow_reveal, meme_format, before_after, reaction, duet_stitch, green_screen, product_showcase, lifestyle_b_roll, educational_slides, trending_audio, foreign_reup. Chỉ tag thấy rõ; không đoán.
  - foreign_reup: BẮT BUỘC gắn khi video là footage nước ngoài (Trung/Hàn/Nhật/Âu…) được reup lên kênh VN với phụ đề/lồng tiếng tiếng Việt — kể cả audio đã lồng tiếng VN (không còn tiếng gốc) hoặc overlay VN có từ «mua», «review» (đó là phụ đề dịch, không phải haul/review native). Dấu hiệu: overlay_style=sub_caption, voiceover_only + text_overlay_heavy, hoặc nội dung gốc Trung/Hàn trên hình. Không gắn cho video creator VN tự quay.
