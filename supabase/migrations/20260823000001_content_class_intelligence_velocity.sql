-- Wave 3a — extend content_class_intelligence with velocity + lifecycle_stage (#2).
-- Recreates MV only (tier MV unchanged). See plan §9.1.
...
COMMENT ON MATERIALIZED VIEW content_class_intelligence IS
  'Wave 3a — class cohort stats + 7d velocity + lifecycle_stage for Morning Signal.';
