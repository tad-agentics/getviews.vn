...
import { pricingPlans, pricingSavings } from '../lib/mockData';
...
const testimonials = [
  {
    ...
    followers: '~50K',
    quote: 'Quăng link video bị flop vào, 1 phút sau biết ngay lỗi: hook chậm 2.3 giây, không có mặt người ở đầu. Sửa lại đúng theo gợi ý — video sau lên thẳng 89K view.',
    stat: '89K view',
  },
  {
    initials: 'LH',
    ...
    followers: '~120K',
    quote: 'Trước đây toàn phải screenshot thủ công rồi quên sạch. Giờ chỉ cần hỏi "hook nào hot tuần này" — AI lọc ra luôn 5 mẫu đang viral nhất, kèm link video gốc để học theo.',
    stat: '3.2x avg views',
  },
  {
    initials: 'TN',
    ...
    followers: '~30K',
    quote: 'Phân tích strategy của 3 đối thủ lớn chỉ trong 2 câu lệnh. Đỡ mất công ngồi "soi" tay cả buổi. Tiết kiệm được ít nhất 4-5 tiếng nghiên cứu mỗi tuần.',
    stat: '−4h/tuần',
  },
];
              ...
              {trendingVideos.map((video, i) => (
                <div key={i} className="flex items-start gap-3 pb-3 border-b border-[var(--border)] last:border-0 last:pb-0 transition-colors duration-200 hover:bg-[var(--surface-alt)] -mx-2 px-2 rounded cursor-pointer">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-medium text-[var(--ink)] line-clamp-2 leading-snug mb-1">
                      {video.title}
                    </p>
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div>
              ...
              >
                ...
                <p className="text-lg text-[var(--ink-soft)] mb-8 max-w-lg leading-relaxed">
                  Quăng link video → Nhận phân tích sau 1 phút. Biết ngay <span className="font-semibold text-[var(--ink)]">lỗi ở đâu</span>, <span className="font-semibold text-[var(--ink)]">hook nào hot</span>, <span className="font-semibold text-[var(--ink)]">format nào cắn đề xuất</span>. Dựa trên số liệu thực, không đoán mò.
                </p>
            ...
            >
              ...
              <div className="bg-white border border-[var(--border)] rounded-xl p-6 shadow-lg">
                <div className="flex items-center gap-3 mb-4 pb-4 border-b border-[var(--border)]">
                  <div className="w-10 h-10 rounded bg-[var(--ink)] flex items-center justify-center text-white font-bold text-xs">
                    GV
                  </div>
                  <div>
          ...
          >
            <div className="flex items-center gap-2">
              <span>Data 100% từ TikTok Việt</span>
            </div>
            ...
            <div className="hidden sm:block w-px h-4 bg-[var(--border)]" />
            <div className="flex items-center gap-2">
              <span>Chuyên biệt cho 17 niche creator</span>
            </div>
          </motion.div>
      ...
      <section className="px-4 py-16 md:py-20 bg-[var(--background)]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              <p className="font-bold text-[var(--ink)] mb-4">"Đối thủ đang đăng gì?"</p>
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-4">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-8 h-8 rounded bg-[var(--ink)] flex items-center justify-center text-white font-bold text-xs">
                    TT
                  </div>
                  <div className="flex-1">
                    <p className="text-xs font-medium text-[var(--ink)]">@mai_skincare</p>
                    <p className="text-xs text-[var(--muted)]">52 video · 7 ngày</p>
                  </div>
                </div>
                <p className="text-xs text-[var(--ink-soft)]">Hook "Cảnh Báo" + Product Demo</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-white border border-[var(--border)] rounded-xl p-6 transition-shadow duration-200 hover:shadow-lg cursor-pointer"
            >
              <p className="font-bold text-[var(--ink)] mb-4">"Creator nào nên hire?"</p>
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-4">
                <div className="space-y-2 mb-3">
                  <div className="flex items-center gap-2 text-xs">
                    <div className="w-6 h-6 rounded bg-[var(--surface-alt)] border border-[var(--border)]" />
                    <span className="text-[var(--ink)]">@review_thucte · 450K</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs">
                    <div className="w-6 h-6 rounded bg-[var(--surface-alt)] border border-[var(--border)]" />
                    <span className="text-[var(--ink)]">@lamdepcunglinh · 380K</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs">
                    <div className="w-6 h-6 rounded bg-[var(--surface-alt)] border border-[var(--border)]" />
                    <span className="text-[var(--ink)]">@tech_vn · 290K</span>
                  </div>
                </div>
                <p className="text-xs text-[var(--ink-soft)]">Skincare · 100K-500K followers</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-white border border-[var(--border)] rounded-xl p-6 transition-shadow duration-200 hover:shadow-lg cursor-pointer"
            >
              <p className="font-bold text-[var(--ink)] mb-4">"Hook nào viral trong fitness app?"</p>
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-4">
                <div className="space-y-2 mb-3">
                  <div className="text-xs">
                    <span className="font-mono text-[var(--ink)]">1.</span>
                    <span className="text-[var(--ink)] ml-2">"Cảnh Báo: đừng..."</span>
                    <span className="text-[var(--muted)] ml-2">2.5K avg</span>
                  </div>
                  <div className="text-xs">
                    <span className="font-mono text-[var(--ink)]">2.</span>
                    <span className="text-[var(--ink)] ml-2">"3 sai lầm khi..."</span>
                    <span className="text-[var(--muted)] ml-2">1.8K avg</span>
                  </div>
                  <div className="text-xs">
                    <span className="font-mono text-[var(--ink)]">3.</span>
                    <span className="text-[var(--ink)] ml-2">"Tôi đã thử để..."</span>
                    <span className="text-[var(--muted)] ml-2">1.2K avg</span>
                  </div>
                </div>
                <p className="text-xs text-[var(--ink-soft)]">17 video · Tuần này</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-white border border-[var(--border)] rounded-xl p-6 transition-shadow duration-200 hover:shadow-lg cursor-pointer"
            >
              <p className="font-bold text-[var(--ink)] mb-4">"Format nào đang lên tuần này?"</p>
              <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-4">
                <div className="space-y-2 mb-3">
                  <div className="flex items-center gap-2 text-xs">
                    <div className="w-1 h-8 bg-[var(--ink)]" />
                    <span className="text-[var(--ink)]">Unboxing + So sánh</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs">
                    <div className="w-1 h-8 bg-[var(--ink)]" />
                    <span className="text-[var(--ink)]">Review thật · 60s</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs">
                    <div className="w-1 h-8 bg-[var(--ink)]" />
                    <span className="text-[var(--ink)]">Hook + Demo nhanh</span>
                  </div>
                </div>
                <p className="text-xs text-[var(--ink-soft)]">Tech & Review · Trending</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      {/* ── Results: Before/After + Testimonials ───────────────── */}
      <section className="px-4 py-16 md:py-20 bg-white">
        <div className="max-w-5xl mx-auto">
            ...
            {plans.map((plan, idx) => (
              <motion.div
                ...
                className={`border rounded-xl p-5 relative bg-[var(--surface)] transition-shadow duration-200 hover:shadow-lg ${
                  plan.popular
                    ? 'border-[var(--ink)] border-2'
                    : 'border-[var(--border)]'
                }`}
              >
                {plan.popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <span className="bg-[var(--ink)] text-white text-xs px-3 py-1 rounded-full font-medium">
                      Phổ biến
                    </span>
                  </div>
                )}
                ...
                <Link to={plan.name === 'Free' ? '/login' : '/login'}>
                  <Button
                    fullWidth
          ...
          <Accordion.Root type="single" collapsible className="space-y-3">
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                <Accordion.Content className="px-5 pb-4 text-sm text-[var(--ink-soft)] data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up" style={{ lineHeight: '1.6' }}>
                  {faq.a}
                </Accordion.Content>
                </Accordion.Item>
              </motion.div>
