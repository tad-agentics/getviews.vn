...
|---|---|---|---|---|
| Explore / Trends | **Trending This Week retired**: removed `TrendingSection`, `useTrendingCards`, `trending_cards.py`, and the `corpus_ingest` weekly hook. `trending_cards` table + Monday Edge digest unchanged. | NO | Yes | — |
