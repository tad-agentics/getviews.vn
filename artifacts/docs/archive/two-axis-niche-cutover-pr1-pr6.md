# Two-axis niche cutover (PR1 → PR6) — archived

> **STATUS: COMPLETED — 2026-05-13.** Historical record only. Current taxonomy SSOT: [`../two-axis-niche-model.md`](../two-axis-niche-model.md). Active ops: [`../two-axis-niche-cutover-runbook.md`](../two-axis-niche-cutover-runbook.md) (HI-11).
