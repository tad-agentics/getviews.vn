...
Use motion (Framer Motion) ONLY for these D1–D4 moments. Not for every element.
...
- PricingCards: vertical stack on mobile (horizontal 3-col on desktop). 4 cards:
  - Free: "Dùng thử" / "Miễn phí" / "10 lần phân tích sâu (lifetime)" / features list / "Bắt đầu miễn phí" button (outlined)
  - Starter: "Starter" / "199.000đ/tháng" (annual) / "30 lần phân tích sâu/tháng + lướt xu hướng không giới hạn" / "Phổ biến nhất" badge / "Nâng cấp Starter" CTA (--purple bg)
  - Pro: "Pro" / "399.000đ/tháng" (annual) / "80 lần phân tích sâu/tháng + không giới hạn browse" / "Nâng cấp Pro" CTA
  - Agency: "Agency" / "1.190.000đ/tháng" (annual) / "250 lần phân tích sâu + 10 tài khoản" / "Nâng cấp Agency" CTA
- AnnualSavings callout below cards: "Tiết kiệm 600.000đ – 3.600.000đ khi mua cả năm"
...
- Include 3–5 items in every list to test visual density (3 DiagnosisRows, 5 HookRankingBars, 5 HookRankingBars, 6 SessionItems)
